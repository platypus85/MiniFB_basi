<?php
    ...
    while($row=pg_fetch_array($result)){
        ...
        if($i==0) $str_hobby = 'Non specificato';        
    ...
    if($num_scuole == 0) $str_scuole .= "<tr> <td> Non ci sono frequentazioni. Clicca su modifica per aggiungerne una o per modificare il profilo utente. </td></tr> ";
    else{
      while($row=pg_fetch_array($result)){
    ...
    $str_scuole .= "</table><br /><br /><br />
                    <input type='button' name='modifprofilo' value='Modifica' onclick=location.href='home.php?action=modifprofilo'>";
